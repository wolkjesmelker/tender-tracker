...
const METHOD_TO_CHANNEL: Record<string, string> = {
  ...
  addManualTenderDocuments: 'tenders:add-manual-documents',
  removeTenderCatalogEntries: 'tenders:remove-catalog-entries',
  ...
  resolveTenderMapGeocodes: 'tenders:resolve-map-geocodes',
  ...
  processUrl: 'tenders:process-url',
  ...
  getTenderUpdates: 'tender-updates:list',
  getTenderUpdatesCount: 'tender-updates:count',
  markTenderUpdateRead: 'tender-updates:mark-read',
  markAllTenderUpdatesRead: 'tender-updates:mark-all-read',
  clearTenderUpdates: 'tender-updates:clear',
  getTenderUpdatesForTender: 'tender-updates:for-tender',
  ...
  exportTenderSummary: 'export:tender-summary',
  ...
  syncGetStatus: 'sync:status',
  syncNow: 'sync:now',
  syncFullPush: 'sync:full-push',
  syncFullPull: 'sync:full-pull',
  ...
  agentDeletePinnedNote: 'agent:delete-pinned-note',
  agentExportFill: 'agent:export-fill',
  agentExportFilledDocument: 'agent:export-filled-document',
  agentGetDocChecklist: 'agent:get-doc-checklist',
  agentToggleDocChecklistItem: 'agent:toggle-doc-checklist-item',
  ...
  releaseCreateDraft: 'release:create-draft',
  releaseDeleteDraft: 'release:delete-draft',
  releasePromoteLive: 'release:promote-live',
}
